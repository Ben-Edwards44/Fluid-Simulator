...
def create_elements(window):
    ...
    global restart
    global texts
    global target_density, pressure_multiplier, near_pressure_mult, visc_strength
    ...
    near_pressure_mult = pygame_ui_toolkit.slider_value_text.create_slider_text(window, constants.SLIDER_X, 150, constants.SLIDER_X + constants.LENGTH // 2 + 30, 150, constants.LENGTH, 5, 0, 10, constants.near_pressure_multiplier, (255, 255, 255), None, 32, (255, 255, 255), antialias=True)
    visc_strength = pygame_ui_toolkit.slider_value_text.create_slider_text(window, constants.SLIDER_X, 200, constants.SLIDER_X + constants.LENGTH // 2 + 30, 200, constants.LENGTH, 5, 0, 1, constants.visc_strength, (255, 255, 255), None, 32, (255, 255, 255), antialias=True)
    ...
    near_press_mult_text = pygame_ui_toolkit.text.RectTextBox(window, constants.SLIDER_X, 130, 1, 1, "Near Pressure Multiplier:", (0, 0, 0), (255, 255, 255), 18, antialias=True)
    visc_text = pygame_ui_toolkit.text.RectTextBox(window, constants.SLIDER_X, 180, 1, 1, "Viscosity:", (0, 0, 0), (255, 255, 255), 20, antialias=True)

    texts = [target_dens_text, pressure_multiplier_text, near_press_mult_text, visc_text]
...
def update():
    ...
    pygame_ui_toolkit.slider_value_text.blit_slider_text(near_pressure_mult)
    ...
    constants.near_pressure_multiplier = near_pressure_mult.value
