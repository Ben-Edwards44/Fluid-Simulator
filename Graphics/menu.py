...
def create_elements(window):
    ...
    target_density = pygame_ui_toolkit.slider_value_text.create_slider_text(window, constants.SLIDER_X, 50, constants.SLIDER_X + constants.LENGTH // 2 + 30, 50, constants.LENGTH, 5, 0, 50, constants.target_density, (255, 255, 255), None, 32, (255, 255, 255))
    pressure_multiplier = pygame_ui_toolkit.slider_value_text.create_slider_text(window, constants.SLIDER_X, 100, constants.SLIDER_X + constants.LENGTH // 2 + 30, 100, constants.LENGTH, 5, 0, 40, constants.pressure_multiplier, (255, 255, 255), None, 32, (255, 255, 255))
    visc_strength = pygame_ui_toolkit.slider_value_text.create_slider_text(window, constants.SLIDER_X, 150, constants.SLIDER_X + constants.LENGTH // 2 + 30, 150, constants.LENGTH, 5, 0, 1, constants.visc_strength, (255, 255, 255), None, 32, (255, 255, 255))
